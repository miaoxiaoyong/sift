...
| V2-03 | launch operation lease claim/reclaim 与 boot recovery barrier | `TestV2OutboxClaimLeaseBackoffAndStableKey`、`TestLaunchClaimWaitsForCurrentBootRecoveryBarrier` | partial → #849 | process/tmux 同 harness |
| V2-04 | dispatch prepare 提交前/后 | `TestLaunchWorkerWrapperCrashSuite/after_prepare` | partial → #849 | 两 backend |
