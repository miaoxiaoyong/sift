...
# Intended for: curl -fsSL https://raw.githubusercontent.com/xsift/sift/main/scripts/install.sh | bash
set -euo pipefail

readonly RELEASE_API_URL="https://api.github.com/repos/xsift/sift/releases/latest"
readonly RELEASE_DOWNLOAD_BASE_URL="https://github.com/xsift/sift/releases/download"
...
Docs: https://github.com/xsift/sift#readme
EOF
