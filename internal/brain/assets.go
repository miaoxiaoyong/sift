...
//go:embed prompts/T1/v1.md prompts/T1/v1.schema.json prompts/T2/v1.md prompts/T2/v1.schema.json prompts/T3/v1.md prompts/T3/v1.schema.json prompts/T4/v1.md prompts/T4/v1.schema.json prompts/T5/v1.md prompts/T5/v1.schema.json prompts/T6/v1.md prompts/T6/v1.schema.json prompts/T7/v1.md prompts/T7/v1.schema.json
...
// T4Asset loads the T4 v1 prompt asset.
func T4Asset() PromptAsset { return mustAsset("T4", 1) }

// T5Asset loads the T5 v1 prompt asset.
func T5Asset() PromptAsset { return mustAsset("T5", 1) }

// T6Asset loads the T6 v1 prompt asset.
func T6Asset() PromptAsset { return mustAsset("T6", 1) }

// T7Asset loads the T7 v1 prompt asset.
func T7Asset() PromptAsset { return mustAsset("T7", 1) }
